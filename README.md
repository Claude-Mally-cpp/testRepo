...
- Replace all occurrences of "Hobbyin the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Hobby` means the name of the project, while `hobby` is used in file names.
  - Remember to rename the `include/hobby` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
