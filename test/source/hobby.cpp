...
//     static_assert(std::string_view(HOBBY_VERSION) ==
//     std::string_view("1.0")); CHECK(std::string(HOBBY_VERSION) ==
//     std::string("1.0"));
// }

TEST_CASE("Divisors") {
    const auto value = 360;
    const auto expectedDivisors =
        std::vector{1,  2,  3,  4,  5,  6,  8,  9,  10, 12,  15,  18,
